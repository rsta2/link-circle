...
#include <ableton/platforms/circle/Clock.hpp>
#include <ableton/platforms/asio/Context.hpp>
#include <ableton/platforms/circle/Random.hpp>
#include <ableton/platforms/circle/ScanIpIfAddrs.hpp>
#endif
...
#elif defined(__circle__)
using Clock = platforms::circle::Clock;
using IoContext =
  platforms::LINK_ASIO_NAMESPACE::Context<platforms::circle::ScanIpIfAddrs, util::NullLog>;
using Random = platforms::circle::Random;
#endif
